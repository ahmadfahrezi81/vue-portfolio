  ...
  <div>
    <div v-if="isDesktop" class="navbar_desktop">
      <ul class="desktop_option">
        <router-link :to="{ path: '/', hash: '#AboutMe' }">About</router-link>
    ...
    <div v-else class="navbar_mobile">
      ...
      <div v-else class="mobile_menu_opened">
        ...
        <ul class="mobile_option">
          <router-link @click="handleMenu" :to="{ path: '/', hash: '' }"
            >Home</router-link
          >
          <router-link @click="handleMenu" :to="{ path: '/', hash: '#AboutMe' }"
            >About</router-link
          >
          <router-link
            @click="handleMenu"
            ...
            >Project</router-link
          >
          <router-link @click="handleMenu" :to="{ path: '/', hash: '#Contact' }"
            >Contact</router-link
          >
        </ul>
